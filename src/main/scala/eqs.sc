...
val cc2 = Account(2, "123", 10, "Martin")

Eq[Account].eqv(cc1, cc2)
Account.Instances.eqById2.eqv(cc1, cc2)
Account.Instances.eqByNumber.eqv(cc1, cc2)


implicit val eqToUse = Account.Instances.eqByNumber
cc1 === cc2
